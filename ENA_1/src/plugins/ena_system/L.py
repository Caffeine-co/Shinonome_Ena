...
# 事件响应器
# --------------------------
ena_help = on_fullmatch(("help","帮助"))    #    airi_help = on_fullmatch(("help","帮助"),priority=99)
...
#"
    text = "\
🎨 Shinonome Ena v-4.5.0 🎨\n\
小窝：絵名の部屋[728556872]\n\
主人：咖啡不甜[2083909754]\n\n\
不要私聊我询问能不能领养之类的，以我的群内通知为准\n\
"
    ...
    #image = MessageSegment.image(os.path.join(os.path.dirname(__file__), 'ena.png'))
    #msg.append({
        #"type": "node",
        #"data": {
            #"name": "Shinonome Enana",
            #"uin": bot.self_id,
            #"content": text + image
        #}
    #})
...
• Haruki相关服务状态：https://status.seiunx.com/status/haruki\n\
"
...
"
    ...
    text = "\
🎨 注意事项 🎨\n\n\
• 每人每天有十次游戏机会，猜卡面和猜曲绘共享，结束游戏也记作一次\n\n\
• 单次游戏回答时间约为30秒\n\n\
• 回答时请务必引用原区域图片消息\n\n\
