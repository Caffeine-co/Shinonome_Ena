...
FOUR_STAR_PATH = Path("Your_path/ENA_1/src/plugins/gacha_resources/限定池/四星卡")
THREE_STAR_PATH = Path("Your_path/ENA_1/src/plugins/gacha_resources/限定池/三星卡")
TWO_STAR_PATH = Path("Your_path/ENA_1/src/plugins/gacha_resources/限定池/二星卡")
...
def is_strict_gacha_command(event: GroupMessageEvent) -> bool:
    ...
    return msg in {"pjsk限定单抽", "pjsk限定十连"}
